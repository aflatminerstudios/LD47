...
if (zoom <= zoomTarget) {    
  ...
  camera_set_view_pos(view_camera[0], objPlayerMicha.x - (room_width * zoom)/2, objPlayerMicha.y - (room_height * zoom)/2);
  camera_set_view_target(view_camera[0], objPlayerMicha);
